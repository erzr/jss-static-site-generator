...
function addGraphQLConfig(baseConfig) {
  ...
  baseConfig.graphQLEndpoint = !disconnected ? `${scjssconfig.sitecore.layoutServiceHost}${
    packageConfig.config.graphQLEndpointPath
  }?sc_apikey=${scjssconfig.sitecore.apiKey}` : `${baseConfig.sitecoreApiHost}${
